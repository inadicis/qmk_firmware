...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [4] = LAYOUT(
        ...
        KC_J,    KC_Y,    KC_W,    KC_I,    KC_O,    KC_P,                _______,    _______,    _______,    _______,    _______,    _______,
        KC_LSFT, KC_A,    KC_S,    KC_D,    KC_L,    KC_K,             _______,    _______,    _______,    _______,    _______,    _______,
        KC_LCTL, KC_N,    KC_M,    KC_COMMA, KC_DOT, KC_SLASH,            _______,    _______,    _______,    _______,    _______,    _______,
